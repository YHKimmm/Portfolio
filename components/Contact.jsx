                            ...
                            <form>
                                <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='border-2 rounded-lg p-3 flex border-gray-300' type="password" />
                                    </div>
                                </div>
                                ...
                                <div className='flex flex-col py-2'>
                                    ...
                                    <textarea className='border-2 rounded-lg p-3 flex border-gray-300' type="text" rows={10} />
                                </div>
